...
def ingresar_pedido():
    ...
    while True:
        try:
            ...
            print("Error. Por favor, ingresar solo números")
    ...
    print("Detalle de la compra actualizada:", detalleCompra)
    ...
    while True:
        try:
            ...
            if not codigo.isdigit() or len(codigo) > 4:
                print("Error: el código debe contener solo números y tener un máximo de 4 dígitos.")
                continue
            ...
            print("Error: el código debe ser un número válido.")
